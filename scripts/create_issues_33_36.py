#!/usr/bin/env python3
"""
Create GitHub issues #33, #34, #35, #36 from issue markdown files.

Usage (PowerShell):
    $env:GITHUB_TOKEN="your-github-token"
    python scripts/create_issues_33_36.py
...
ISSUE_FILES = [
    "033-add-chart-summary-buttons-data-queries.md",
    "034-default-single-coin-actions-to-btc.md",
    "035-remove-eth-price-info-buttons.md",
    "036-section-navigation-flow-description.md",
]

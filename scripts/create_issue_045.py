#!/usr/bin/env python3
"""Create GitHub issue from issues/045-stablecoins-aggregate-usdt-d-all-stables.md."""
...
ISSUE_FILE = "045-stablecoins-aggregate-usdt-d-all-stables.md"
...
def main() -> None:
    ...
    resp = requests.post(
        url,
        headers=headers,
        json={"title": title, "body": body, "labels": ["feature", "stablecoins", "data"]},
    )

#!/usr/bin/env python3
"""Create GitHub issue from issues/044-commodities-support-gold-xau-silver-xag-copper-xcu.md."""
...
ISSUE_FILE = "044-commodities-support-gold-xau-silver-xag-copper-xcu.md"
...
def main() -> None:
    ...
    resp = requests.post(
        url,
        headers=headers,
        json={"title": title, "body": body, "labels": ["feature", "telegram-bot", "commodities"]},
    )
